...
class SceneAssetsTest {
    ...
    @ParameterizedTest
    @CsvSource({
        "ui-forest-strip.svg, 274, 1800",
        "ui-water-strip.svg, 1920, 600"
    })
    void forestAndWaterStripsAreServedWithTheirExactDimensions(String fileName, String width, String height)
            throws Exception {
