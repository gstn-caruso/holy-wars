...
@Import({TownSceneConfiguration.class, FreePlotSceneControllerTest.FixedClockConfiguration.class})
class FreePlotSceneControllerTest {
    ...
    @Test
    void townSceneReferencesTheFreePlotSpriteMatchingEachPlotKind() throws Exception {
        ...
        mockMvc.perform(get("/towns/1/scene"))
                ...
                .andExpect(content().string(containsString("href=\"/img/plot-free.svg\"")))
                .andExpect(content().string(containsString("href=\"/img/plot-free-coast.svg\"")))
                .andExpect(content().string(containsString("href=\"/img/plot-free-wall.svg\"")));
    }
